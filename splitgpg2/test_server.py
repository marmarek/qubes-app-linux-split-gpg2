...
class TC_Server(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.server = self.loop.run_until_complete(
            self.loop.create_unix_server(self.setup_server_protocol,
                                         self.socket_path))
